...
- Sistema de documentación basado en Starlight con búsqueda integrada

## Tecnologías Utilizadas

- Astro como framework de sitio estático
- Starlight para la experiencia de documentación
- Tailwind CSS para estilos
- Preline UI open-source Tailwind CSS components library. <https://preline.co/>
- MDX para contenido dinámico
- GitHub Pages para despliegue (configurado)
